...
const Hero = () => {
  ...
  return (
    <section className="min-h-screen flex flex-col items-center justify-center relative px-4">
      <div className="flex gap-4 mb-12 animate-in fade-in slide-in-from-top duration-700">
      ...
      <h1 className="text-5xl md:text-7xl font-bold text-center mb-6 animate-in fade-in slide-in-from-bottom duration-700 delay-150">
        Discover Upcoming
        <br />
        <span className="text-orange">Department Events</span>
      </h1>

      <p className="text-lg md:text-xl text-muted-foreground text-center max-w-3xl mb-8 animate-in fade-in slide-in-from-bottom duration-700 delay-300">
        Stay updated with workshops, hackathons, and fests. Join your community and never
        miss an opportunity to learn and grow.
      </p>

      <div className="flex items-center gap-4 animate-in fade-in slide-in-from-bottom duration-700 delay-500">
        <Button 
          size="lg" 
